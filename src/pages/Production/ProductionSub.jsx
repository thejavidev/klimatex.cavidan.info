                ...
                <TabPanels>
                  {
                    currentItem && currentItem?.map((cur, i) => (
                      <TabPanel key={i} className='p-0'>
                        <Row>
                          <Col lg={12} className='bg-[--textfff] mt-[2rem] pt-[30px] pb-[30px] pl-[50px] pr-[50px] lg:pl-[10px] lg:pr-[10px]'>
                            <Row>
                              <Col lg={8} className='p-0'>
                                <div className="flex items-center ">
                                  <div className="flex flex-col justify-center gap-y-4 p-[20px]">
                                    <div className="flex items-center">
                                      <h2 className='text-[#000] text-[20px] md:text-[16px] font-[600] capitalize'>{t("material")}</h2>
                                      <span className='pt-0 pb-0 pl-[10px] pr-[10px]'>-</span>
                                      <h3 className='text-[#000] pl-[10px] font-[300] text-[18px] md:text-[16px]  capitalize'>{ml(cur?.material_az, cur?.material_ru, cur?.material_en)}</h3>
                                    </div>
                                    <div className="flex items-center">
                                      <h2 className='text-[#000] text-[20px] md:text-[16px]  font-[600] capitalize'>{t("color")}</h2>
                                      <span className='pt-0 pb-0 pl-[10px] pr-[10px]'>-</span>
                                      <h3 className='text-[#000] pl-[10px] font-[300] text-[18px] md:text-[16px]  capitalize'>{ml(cur?.reng_az, cur?.reng_ru, cur?.reng_en)}</h3>
                                    </div>
                                    <div className="flex items-center">
                                      <h2 className='text-[#000] text-[20px] font-[600] md:text-[16px]  capitalize'>{t("usage")}</h2>
                                      <span className='pt-0 pb-0 pl-[10px] pr-[10px]'>-</span>
                                      <h3 className='text-[#000] pl-[10px] font-[300] text-[18px] md:text-[16px]  capitalize'>{ml(cur?.istifade_az, cur?.istifade_ru, cur?.istifade_en)}</h3>
                                    </div>
                                    <div className="flex items-center">
                                      <h2 className='text-[#000] text-[20px] font-[600] md:text-[16px]  capitalize'>{t("features")}</h2>
                                      <span className='pt-0 pb-0 pl-[10px] pr-[10px]'>-</span>
                                      <h3 className='text-[#000] pl-[10px] font-[300] text-[18px] md:text-[16px]  capitalize'>{ml(cur?.xususiyyetler_az, cur?.xususiyyetler_ru, cur?.xususiyyetler_en)}</h3>
                                    </div>
                                  </div>
                                </div>
                              </Col>
                        ...
                        <Col lg={12} className='bg-[--bgef] mt-[2rem] pt-[30px] pb-[30px] pl-[50px] pr-[50px] lg:pl-[10px] lg:pr-[10px]'>
                            <Row className='items-start justify-start'>
                              ...
                              <Col lg={4}>
                                <div className="flex flex-col w-full gap-[15px] overflow-hidden">
                                  <Col lg={12} xs={12} className='flex items-center justify-center bg-[--textfff] w-full pt-[10px] pb-[10px] pl-[20px] pr-[20px] text-center'>
                                    {ml(cur?.sbk2alt_az, cur?.sbk2alt_ru, cur?.sbk2alt_en)}
                                  </Col>
                                  <div className="flex w-full gap-x-[20px] justify-between h-full">
                                    <Col lg={4} xs={4} className='flex items-center justify-center bg-[--textfff] pt-[10px] pb-[10px] pl-[20px] pr-[20px] text-center'>
                                      {ml(cur?.sbk2_az, cur?.sbk2_ru, cur?.sbk2_en)}
                                    </Col>
                                    <Col lg={8} xs={8} className='flex items-center justify-center bg-[--textfff] pt-[10px] pb-[10px] pl-[20px] pr-[20px] text-center'>
                          ...
                          <Col lg={12} className='bg-[--textfff] mt-[2rem] pt-[30px] pb-[30px] pl-[50px] pr-[50px] lg:pl-[10px] lg:pr-[10px]'>
                            <div className="flex flex-col justify-start items-start">
                              <h2 className='font-[400] text-[25px] lg:text-[20px] pb-[50px]'>{ml(cur?.iki_qanadli_barmaqliq_az, cur?.iki_qanadli_barmaqliq_ru, cur?.iki_qanadli_barmaqliq_en)}</h2>
                              <LazyLoadImage src={cur?.image_4} className=' w-[800px] ' />
                            </div>
                          </Col>
                          <Col lg={12} className='bg-[--bgef] mt-[2rem] pt-[30px] pb-[30px] pl-[50px] pr-[50px] lg:pl-[10px] lg:pr-[10px]'>
                            <div className="flex flex-col">
                              <h2 className='font-[400] text-[25px] lg:text-[20px] pb-[50px]'>{ml(cur?.barmaqliq_secimi_cedveli_az, cur?.barmaqliq_secimi_cedveli_ru, cur?.barmaqliq_secimi_cedveli_en)}</h2>
