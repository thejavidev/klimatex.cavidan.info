          ...
          <Container fluid >
            <Row  >
              <Col lg={6} className="flex justify-center flex-col">
                ...
                <div className='columns-2 flex flex-col gap-[40px] text-justify' dangerouslySetInnerHTML={{ __html: homeAPI[1]?.data && homeAPI[1]?.data?.missiya_text_az }}></div>
                <p className='mt-[40px] flex items-center'>
                  <a href={`tel:${str}`} className='text-[--text] text-[18px]'><LocalPhoneIcon fontSize="large" className='bg-[--textsky] rounded-full text-[--textfff] p-[5px]' /> {phone} </a>
                </p>
              </Col>
              <Col lg={6}>
