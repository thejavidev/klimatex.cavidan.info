    ...
    <>
      ...
      >
        <div className="relative w-full breadcump">
          ...
          <div className="" >
            <h2 className='absolute top-[65%] left-[50%] z-5 text-[#fff] text-[40px] lg:text-[25px] font-[200] capitalize transfrom70'>{t("license")}</h2>
          </div>
        </div>
                ...
                licency && licency?.map((cur, i) => (
                  <Col key={i} lg={3} md={4} sm={6} xs={6}>
                    <div className="relative grayscale1 tansitionall">
                     ...
                     text-[#fff] text-[25px] md:text-[20px] opacity-[0] capitalize tansitionall' >{ml(cur?.name_az, cur?.name_ru, cur?.name_en)}</h2>
                    </div>
