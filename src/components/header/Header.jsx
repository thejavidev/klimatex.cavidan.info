...
const Header = ({ data }) => {
  ...
  return (
    <>
      ...
      <header className={`header absolute top-0 left-0 right-0 w-full z-[150]  pl-[100px] pr-[100px] xl:pl-[50px] xl:pr-[50px] lg:pl-[20px] lg:pr-[20px] md:pl-[0px] md:pr-[0px]`}>
        <Container fluid >
          ...
          <nav className='flex flex-wrap justify-between w-full pt-[10px] pb-[10px] pl-[10px] pr-[10px] bg-[--textfff]'>
            <div className="flex justify-center items-center  cursor-pointer">
              <Link to={'/'}>
                <LazyLoadImage src={kl_logo} className='w-[120px] headerlogo' />
              </Link>
            </div>
            <div className="">
              ...
              <ul className='flex items-center justify-end w-full lg:hidden'>
                {
                  menu && menu?.map((cur, i) => (
